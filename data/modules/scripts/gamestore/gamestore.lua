...
GameStore.Categories = {
	...
	},
	{
		...
		offers = {
			...
			{name = "health potion keg", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, price = 15, thingId = 28579, count = 500, icons = {"28577.png"}},
			{name = "strong health potion keg", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, price = 15, thingId = 28580, count = 500, icons = {"28578.png"}},
			{name = "great health potion keg", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, price = 15, thingId = 28581, count = 500, icons = {"28579.png"}},
			{name = "ultimate health potion keg", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, price = 15, thingId = 28581, count = 500, icons = {"28580.png"}},
			{name = "supreme health potion keg", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, price = 15, thingId = 28583, count = 500,  icons = {"28581.png"}},
			{name = "mana potion keg", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, price = 15, thingId = 28584, count = 500, icons = {"28582.png"}},
			{name = "strong mana potion keg", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, price = 15, thingId = 28585, count = 500, icons = {"28583.png"}},
			{name = "great mana potion keg", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, price = 15, thingId = 28586, count = 500, icons = {"28584.png"}},
			{name = "ultimate mana potion keg", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, price = 15, thingId = 28587, count = 500, icons = {"28585.png"}},
			{name = "great spirit potion keg", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, price = 15, thingId = 28589, count = 500, icons = {"28587.png"}},
			{name = "ultimate spirit potion keg", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, price = 15, thingId = 28590, count = 500, icons = {"28588.png"}},
		}
	},
	{
		name = "Outfits",
